...
[ Mysql::Result#fetch_as_hash() ]
	...
	<tt>{'id'=>1, 'float'=>3.14, 'date'=>Time.mktime(2008, 1, 1), 'flag'=>true}</tt>
	while Mysql::Result#fetch_as_hash() returns
	<tt>{'id'=>"1", 'float'=>"3.14", 'date'=>"2008-01-01", 'flag'=>"1"}</tt>
	.
...
[ Mysql::Result#fetch_as_array() ]
	...
	<tt>{1, 3.14, Time.mktime(2008, 1, 1), true}</tt>
	while Mysql::Result#fetch_row() returns
	<tt>{"1", "3.14", "2008-01-01", "1"}</tt>
	.
